...
met_1400 <- function(exposure_path,outcome_path,
  ...
  # 检查存档
  checkpoint_path<<-paste0('1400(',p_threshold,')-',outcome_source,'.RData')
  ...
  final_path=paste0('1400(',p_threshold,')-',outcome_source,'.csv')
